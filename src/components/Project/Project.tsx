      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Prabhunandan016/missingchilddetector" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
                <a href="https://drive.google.com/drive/folders/1v45TMd8243Y7kd-F_pBOJjWs6QP8SNEp" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> 
              </div>
            </header>
            <div className="body">
              <h3>Missing Child Detection</h3>
              <p>
                Developed an AI-powered Missing Child Detection system integrating facial recognition models to identify and match missing individuals from image uploads. The system automates report handling, compares facial embeddings for similarity, and sends real-time email alerts to administrators and reporters upon potential matches.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="fadeInUp">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Prabhunandan016/budgetadvisor" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Shopping Budget Advisor</h3>
              <p> Built a machine learning-powered application that recommends a personalized shopping budget by analyzing key financial factors like income, rent , medical and other expenses. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Python</li> <li>Machine Learning</li> <li>Pandas</li> <li>Kaggle</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="fadeInUp">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Prabhunandan016/TurfBooking" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://turf-booking-zeta.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Turf Booking</h3>
              <p>
                Built a modern frontend turf booking website featuring responsive layouts, smooth navigation, and interactive booking sections for sports facilities. Focused on delivering a seamless user experience through clean design and intuitive UI.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="fadeInUp">
          <div className="project">
            ...
            <div className="body">
              <h3>Driver Phone Usage Detection</h3>
              <p>Developed a driver phone usage detection system using Convolutional Neural Networks (CNN) to identify distracted driving behavior from real-time images, enabling accurate detection of phone usage and promoting road safety through AI-driven monitoring.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Python</li>
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://spammailapp-3d6xsmkhjbsjemuh9ckxyw.streamlit.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
                Developed an intelligent spam detection system that automatically classifies emails as spam or legitimate using machine learning and NLP. The model delivers high accuracy and enables real-time predictions, improving communication security and efficiency.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="fadeInUp">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Prabhunandan016/weather-app" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://weather-app-woad-tau-93.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
